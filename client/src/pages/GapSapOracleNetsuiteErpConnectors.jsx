...
// v0 scaffold for: SAP, Oracle, NetSuite ERP connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-sap-oracle-netsuite-erp-connectors/run.

export default function SapOracleNetsuiteErpConnectorsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-sap-oracle-netsuite-erp-connectors/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>SAP, Oracle, NetSuite ERP connectors</h1>
