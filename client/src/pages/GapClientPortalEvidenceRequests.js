...
// v0 scaffold for: No client portal for evidence requests
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-client-portal-evidence-requests/run.

export default function ClientPortalEvidenceRequestsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-client-portal-evidence-requests/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No client portal for evidence requests</h1>
