...
// v0 scaffold for: Limited AI audit-risk assessment for inherent vs. control risk
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-limited-ai-audit-risk-assessment/run.

export default function LimitedAiAuditRiskAssessmentPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-ai-audit-risk-assessment/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Limited AI audit-risk assessment for inherent vs. control risk</h1>
