...
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-xbrl-10-k-10-q/run.

export default function Xbrl10K10QPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-xbrl-10-k-10-q/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>XBRL / 10-K / 10-Q parsing for automated audit procedures</h1>
